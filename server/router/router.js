...
module.exports = app => {
    ...
    app.get('/register', (req, res) => {
        ...
        function writeJson(params) {
            ...
            fs.readFile('./server/data/user.json', function (err, data) {
                ...
                fs.writeFile('./server/data/user.json', str, function (err) {
                    if (err) {
    ...
    app.get('/delete', (req, res) => {
        ...
        function deleteJson(id) {
            fs.readFile('./server/mock/person.json', function (err, data) {
                if (err) {
                    return console.error(err);
                }
                ...
                //然后再把数据写进去
                fs.writeFile('./server/mock/person.json', str, function (err) {
                    if (err) {
                        console.error(err);
                    }
                    console.log("----------删除成功------------");
    ...
    app.get('/banner', (req, res) => {
        ...
        function writeJson(params) {
            //现将json文件读出来
            fs.readFile('./server/data/banner.json', function (err, data) {
                console.log(data);
                if (err) {
    ...
    app.get('/product', (req, res) => {
        ...
        function writeJson(params) {
            //现将json文件读出来
            fs.readFile('./server/data/product.json', function (err, data) {
                console.log(data);
                if (err) {
    ...
    app.get('/detail', (req, res) => {
        ...
        function writeJson(params) {
            //现将json文件读出来
            fs.readFile('./server/data/proDetail.json', function (err, data) {
                console.log(data);
                if (err) {
    ...
    app.post('/address', (req, res) => {
        ...
        function writeJson(params) {
            //现将json文件读出来
            fs.readFile('./server/data/address.json', function (err, data) {
                // console.log(data);
                if (err) {
                    return console.error(err);
                }
                ...
                var str = JSON.stringify(person);//因为nodejs的写入文件只认识字符串或者二进制数，所以把json对象转换成字符串重新写入json文件中
                fs.writeFile('./server/data/address.json', str, function (err) {
                    if (err) {
    ...
    app.post('/addCar', (req, res) => {
        ...
        // 添加前先查询购物车是否有该商品
        fs.readFile('./server/data/car.json', function (err, data) {
            // console.log(data);
            if (err) {
        ...
        function writeJson(params) {
            ...
            fs.readFile('./server/data/car.json', function (err, data) {
                ...
                console.log('person.data==>', person);
                var str = JSON.stringify(person);//因为nodejs的写入文件只认识字符串或者二进制数，所以把json对象转换成字符串重新写入json文件中
                fs.writeFile('./server/data/car.json', str, function (err) {
                    if (err) {
                        res.send({ msg: "添加购物车失败", stutas: 1200 })
                        console.error(err);
                    }
    ...
    app.post('/order', (req, res) => {
        ...
        function writeJson(params) {
            //现将json文件读出来
            fs.readFile('./server/data/order.json', function (err, data) {
                // console.log(data);
                if (err) {
                ...
                console.log('person.data==>', person);
                var str = JSON.stringify(person);//因为nodejs的写入文件只认识字符串或者二进制数，所以把json对象转换成字符串重新写入json文件中
                fs.writeFile('./server/data/order.json', str, function (err) {
                    if (err) {
                        res.send({ msg: "添加订单失败", stutas: 1400 })
                        console.error(err);
                    }
